...
Page({
  ...
  data: {
    currentTab: '0', // 当前tab
    reqUrl: 'https://unsplash.com/napi/feeds/home', // 当前请求url
    paging: {
      idnex: 1,
      size: 10
    },
  ...
  swichNav: function (e) {
    ...
    if (that.data.currentTab === e.target.dataset.current) {
      ...
      that.data.reqUrl = 'https://unsplash.com/napi/feeds/home';
      that.getTrendingPicInfo('top');
    } else {
      that.data.reqUrl = 'https://unsplash.com/napi/photos';
   ...
   * 获取Trending图片
   */
  getTrendingPicInfo: function (type) {
    let that = this;
    app.sendRequest({
